...
export function applyHMR(hotOptions, id, moduleHot, component) {
	// DEBUG DEBUG DEBUG this try/catch around accept/decline is probably
	// nonsense to webpack... need to dig into that (or find someone
	// knowledgeable about webpack HMR)
	// 
